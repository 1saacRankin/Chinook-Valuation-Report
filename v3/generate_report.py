...
# # \includegraphics[width=0.35\textwidth]{Chinook_logo.png}
...
# # \draw[thick] (4,0) -- (4,0.4);
# # \node[anchor=south,font=\tiny] at (4,0.5) {0};
# # \end{tikzpicture}
# # \end{center}
...
# % Full-width black rectangle with left-aligned text
...
# \begin{description}[style=nextline,leftmargin=2cm,itemsep=8pt]
...
#         'customers_ask_by_name_pct': str(owner_dep['questions']['customers_ask_by_name_pct'])
#     }
...
#         'revenue_increase_capacity': str(growth['questions']['revenue_increase_capacity'])
#     }
...
#         'top_5_customers_pct': str(org_stab['questions']['top_5_customers_pct']),
