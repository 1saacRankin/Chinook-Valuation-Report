...
{\LARGE\bfseries Persaj Countertops Inc.\par}
\vspace{0.5cm}
...
{\Huge\bfseries\color{primarypurple} \$2,624,652}

\vspace{1cm}

\subsection*{Valuation Multiples}

This price was determined using a market-based approach which examined 16 comparable transactions. These transactions included businesses with revenues between \$2,816,110 and \$3,705,479. An asking price of \$2,624,652 represents the following valuation multiples:
\end{minipage}%
\hfill
...
\hline
\rowcolor{tableodd}
\textbf{Net Income} & \$510,875 & \$575,709 & \$29,230 & \$241,742 & \$64,167 \\
\hline
\rowcolor{white}
\textbf{Total Normalizations} & \$230,000 & \$102,963 & \$115,976 & \$118,455 & \$129,809 \\
\hline
\rowcolor{tableodd}
\textbf{SDE} & \$740,875 & \$678,672 & \$145,206 & \$360,197 & \$193,976 \\
\hline
\rowcolor{white}
\textbf{Adj. EBITDA} & \$620,875 & \$558,672 & \$35,206 & \$260,197 & \$103,976 \\
\hline
\rowcolor{tableodd}
...
\textbf{Weighted Average of SDE} & \$709,773 \\
...
\hline
\rowcolor{tableodd}
\textbf{Net Income \%} & 17.24\% & 17.38\% & 1.12\% & 10.60\% & 3.71\% \\
\hline
\end{tabular}
\end{center}
...
\hline
\rowcolor{tableodd}
Net Income & \$510,875 & \$575,709 & \$29,230 & \$241,742 & \$64,167 & \\
\hline
\rowcolor{white}
...
\hline
\rowcolor{white}
Interest on Equipment under Capital Lease & \$0 & \$4,171 & \$11,606 & \$15,007 & \$14,951 & \\
\hline
\rowcolor{tableodd}
...
\hline
\rowcolor{white}
Replace owner with manager & \$120,000 & \$120,000 & \$110,000 & \$100,000 & \$90,000 & \\
\hline
\rowcolor{tableodd}
\textbf{Adjusted EBITDA} & \$620,875 & \$558,672 & \$35,206 & \$260,197 & \$103,976 & \\
\hline
\rowcolor{white}
\textbf{Year Weighting} & 50\% & 50\% & 0\% & 0\% & 0\% & \\
\hline
...
\hline
\rowcolor{tableodd}
Cost of Goods & 57.81\% & 65.68\% & Good \\
\hline
\rowcolor{white}
Total Expenses & 25.19\% & 28.55\% & Good \\
\hline
\end{tabular}
\end{center}
...
On average, total employment costs in your industry are 33.06\% of revenue. In comparison, your total employment costs are 0.00\%.
...
\fill[primarypurple] (5.355004716113685,0.3) circle (0.35);
% Add labels below
\node[anchor=north,font=\small] at (0,-0.2) {\$2,022,853};
\node[anchor=north,font=\bfseries\large] at (6,-0.2) {\$2,624,652};
\node[anchor=north,font=\small] at (12,-0.2) {\$3,371,421};
\end{tikzpicture}
\end{center}
...
\hline
\rowcolor{tableodd}
Businesses typically have higher valuations when processes are documented. Does your firm have documented systemized business processes? & We have some things written down \\
\hline
\rowcolor{white}
Do you hire an accountant to prepare your year-end Financial Statements and/or tax returns? & Yes \\
\hline
\rowcolor{tableodd}
Do you prepare an annual operating budget? & No \\
\hline
\rowcolor{white}
...
\begin{tikzpicture}[scale=0.9]
\draw[<->,thick] (0,0) -- (8,0);
\node[anchor=north,font=\small] at (0,-0.2) {\$-164,040};
\node[anchor=north,font=\small] at (8,-0.2) {\$164,040};
...
\hline
\rowcolor{tableodd}
Would your company thrive if you left for 2 months? & No \\
\hline
\rowcolor{white}
Have you taken a vacation longer than 1 month in the past 2 years? & No \\
\hline
\rowcolor{tableodd}
On a normal day, what percentage of customers ask for you by name? & 0% \\
\hline
\end{tabular}
\end{center}
...
\hline
\rowcolor{tableodd}
Have you identified growth opportunities in your business? & Yes \\
\hline
\rowcolor{white}
In your current space and with your current equipment, by how much could you increase revenues? & 25% \\
\hline
\end{tabular}
\end{center}
...
\begin{tikzpicture}[scale=0.9]
\draw[<->,thick] (0,0) -- (8,0);
\node[anchor=north,font=\small] at (0,-0.2) {\$-98,424};
\node[anchor=north,font=\small] at (8,-0.2) {\$98,424};
\draw[thick] (4,0) -- (4,0.4);
\node[anchor=south,font=\tiny] at (4,0.5) {0};
\end{tikzpicture}
\end{center}
...
\hline
\rowcolor{tableodd}
Which one of these best describes your revenue model? & Your revenue is dependent on customers walking in/calling in to order/ordering online. (eg. retail store, restaurant, construction services) \\
\hline
\end{tabular}
\end{center}
...
\begin{tikzpicture}[scale=0.9]
\draw[<->,thick] (0,0) -- (8,0);
\node[anchor=north,font=\small] at (0,-0.2) {\$-65,616};
\node[anchor=north,font=\small] at (8,-0.2) {\$65,616};
\draw[thick] (4,0) -- (4,0.4);
\node[anchor=south,font=\tiny] at (4,0.5) {0};
\end{tikzpicture}
\end{center}
...
\hline
\rowcolor{tableodd}
How much revenue does your largest customer represent? & Less than 5% \\
\hline
\rowcolor{white}
How much revenue does your 5 largest customers represent? & 10%-24% \\
\hline
\rowcolor{tableodd}
If this person isn't you, could you easily replace the person most responsible for sales and marketing in your business? & It is me \\
\hline
\rowcolor{white}
If this person isn't you, could you easily replace the person most responsible for product/service design \& delivery in your business? & It is me \\
\hline
\rowcolor{tableodd}
Could you easily replace the most important outside supplier to your business? & Yes \\
\hline
\end{tabular}
\end{center}
...
\hline
\rowcolor{tableodd}
Do you collect customer feedback with a documented process? & No \\
\hline
\rowcolor{white}
How much do you spend on marketing as a percentage of gross revenue? & 1-5% \\
\hline
\rowcolor{tableodd}
Do you show up on the first page on a local Google search in your industry? & Yes \\
\hline
\rowcolor{white}
Do you have a written customer acquisition strategy? & No \\
\hline
\end{tabular}
\end{center}
