...
\draw[fill=primarypurple] (5.355004716113685,0.25) circle (0.3);
\node[anchor=north] at (0,-0.1) {\$2,022,853};
\node[anchor=north] at (6,-0.1) {\textbf{\$2,624,652}};
\node[anchor=north] at (12,-0.1) {\$3,371,421};
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}
\draw[<->] (0,0) -- (8,0);
\node[anchor=north] at (0,-0.1) {\$-164,040};
\node[anchor=north] at (8,-0.1) {\$164,040};
\draw (4,0) -- (4,0.3);
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}
\draw[<->] (0,0) -- (8,0);
\node[anchor=north] at (0,-0.1) {\$-98,424};
\node[anchor=north] at (8,-0.1) {\$98,424};
\draw (4,0) -- (4,0.3);
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}
\draw[<->] (0,0) -- (8,0);
\node[anchor=north] at (0,-0.1) {\$-65,616};
\node[anchor=north] at (8,-0.1) {\$65,616};
\draw (4,0) -- (4,0.3);
\end{tikzpicture}
\end{center}
